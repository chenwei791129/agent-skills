...
| `gws-gmail` | Operate Gmail through the gws CLI — mailbox triage, label taxonomies, filter design, and bulk archive/delete, with the API's silent-failure traps and untrusted-mail rules |
